...
RUBRICS: dict[str, str] = {
    "probe": (
        ...
        "NEW fact; the OLD pre-update value = fail. contradiction: must use the "
        "NEW/current fact and must not act on the old contradicted value. "
        "longhorizon_recall: must use the far-back stated fact, even if it was "
        "many turns earlier. entity_isolation: must use the facts for the named "
        "project/entity only; using another project's constraints or goals = fail. "
        "anaphora / "
